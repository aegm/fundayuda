...
CREATE TABLE `solicitud` (
  ...
  `MONTO_APROBADO` varchar(20) DEFAULT NULL,
  `TRABAJADOR_SOCIAL` varchar(100) DEFAULT NULL,
  `FECHA_VISITA` date DEFAULT NULL,
  `COD_CENTRO` int(2) DEFAULT NULL,
  `STATUS_INFORME` varchar(10) DEFAULT NULL,
  `OBSERVACIONES_SUBCIDIO` varchar(100) DEFAULT NULL,
  `CEDULA_RIF_USR` varchar(12) NOT NULL DEFAULT '',
  `CEDULA_RIF_SUB` varchar(12) DEFAULT NULL,
  PRIMARY KEY (`ID_SOLICITUD`),
  KEY `FK_COD_SOLICITUD` (`COD_SOLICITUD`),
  KEY `FK_COD_CENTRO` (`COD_CENTRO`),
  CONSTRAINT `FK_COD_CENTRO` FOREIGN KEY (`COD_CENTRO`) REFERENCES `centro_medico` (`COD_CENTRO`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- ----------------------------
INSERT INTO `solicitud` VALUES ('3', '1', 'prueba al sistema', '600,00', '2011-10-27', 'Sin Procesar', null, null, null, null, null, null, '16595338', null);
INSERT INTO `solicitud` VALUES ('4', '2', 'construccion casa', '50.000,00', '2011-10-30', 'Sin Procesar', null, null, null, null, null, null, '16595338', null);
...
INSERT INTO `usuario` VALUES ('1234567', 'J-12121211-2', null, null, null, '1', 'Alcaldia', '(121) 2121-212', 'angeledu@gmail.com', 'La Isabelica', '123456', 'Pedro Rojas');
