...
class ADODB_Pager {
	...
	//
	function ADODB_Pager(&$db,$sql,$id = 'adodb', $showPageLinks = false, $gridAttributes, $first, $prev, $next, $last)
	{
	global $PHP_SELF;
	...
	global $PHP_SELF;
		...
		if ($anchor) {
		?>
		<a href="javascript:void(1)" onclick="<?php echo $_SESSION['funcion_ajax_paginator']."('".$this->id."',".($this->rs->AbsolutePage()+1).")"; ?>"><?php echo $this->next;?></a> &nbsp; 
		<?php
		} else {
			print "$this->next &nbsp; ";
		}
